...
function f3() {
    let all_divs  = document.getElementsByClassName('out-3');

    for(let item of all_divs){
        item.textContent = 3;
    }
}
...
function f4() {
    let all_divs  = document.querySelectorAll('.out-4');
...
function f6() {
    ...
    document.querySelector('.out-6').textContent = new_arr;
}
...
function f9() {
    ...
    for(let i=0; i<a9.length; i++){
        if(a9[i].length-1 > max_ind){
            max_ind = a9[i].length-1;
        }
    }
    return max_ind;
}
...
function f15() {
    let all_divs = document.querySelectorAll('.out-15');
    for(let item of all_divs){
        item.textContent = 15;
    }
}
