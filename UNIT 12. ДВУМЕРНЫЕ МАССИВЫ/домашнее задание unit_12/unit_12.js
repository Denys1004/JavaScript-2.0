...
function f15() {
    ...
    for(let i=0; i<a15.length; i++){
        if(a15[i].length > max_str){
            max_str = a15[i].length;
        }
    }
    out_15.textContent = max_str;
...
/// Наверное здесь ошибкаб здесь Вы обращаетесь к а19.
// console.log(a19[1][1][1] == 9);
// console.log(a19[2][2] == 18);
// console.log(a19[3]== 12);

// а всякий случай копирую с а20
