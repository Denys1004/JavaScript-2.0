...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=9&num2=5')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=9&num2=5')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=8&num2=4')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        body: 'auth=5ADcB96BA48d3f80&action=2&name=Denys',
    })
    .then(data => {
        return data.text();
    })
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        body: 'auth=5ADcB96BA48d3f80&action=3&num1=9&num2=56',
    })
    .then(data => {
        return data.text();
    })
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        body: 'auth=5ADcB96BA48d3f80&action=4&num1=9&num2=12',
    })
    .then(data => {
        return data.text();
    })
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        body: 'auth=5ADcB96BA48d3f80&action=6&num1=34&num2=34',
    })
    .then(data => {
        return data.text();
    })
