...
let goods2 = new Goods ('hat', 1);
goods2.draw('out-4', 29, 1);
...
let goods3 = new Goods2 ('pants', 1); 
goods3.draw('out-6', 35, 2, 'true');
...
let obj2 = new Valid('obj2', '1234567');
obj2.validate();
...
let valid2 = new Valid2('valid2', '12345678', '');
valid2.validate();
console.log(valid2);
...
let valid3 = new Valid2('valid3', '12345678', 'denys@gmail.com');
valid3.validate();
console.log(valid3);