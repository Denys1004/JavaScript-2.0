...
function f7() {
    ...
    let input_field = document.querySelector('.i-7');

    let password = input_field.value;
    output71.innerHTML = password;
...
function f8() {
    let div_out8 = document.querySelector('.out-8');
    // creating button  and input inside of div_out8
    div_out8.innerHTML = "<input type='text' class='newinput'><button class='newbutton'>Show</button>";

    // saving new button into a variable and adding event.
    let newbutton = document.querySelector('.newbutton');
    newbutton.onclick = f81;
}

function f81 () {
    let div_out81 = document.querySelector('.out-81');
    let newinput = document.querySelector('.newinput');
    div_out81.innerHTML = newinput.value;
}
...
function f9() {
    let input_field = document.querySelector('.r-9');
    let output = document.querySelector('.out-9');
    console.log(input_field.checked);
    if(input_field.checked){
        output.innerHTML = input_field.value;
    }else{
        output.innerHTML = '0';
    }
...
function f10() {
    let input_field = document.querySelector('.i-10');
    let output = document.querySelector('.out-10');

    let color = input_field.value;
...
function f11() {
    let input_field1 = document.querySelector('.i-111');
    let input_field2 = document.querySelector('.i-112');

    let color_1 = input_field1.value;
    input_field2.value = color_1;
}
...
function f12() {
    let input_field = document.querySelector('.i-12');
    let output = document.querySelector('.out-12');
    let cur_date = input_field.value;
    output.innerHTML = cur_date;
}
...
function f13() {
    let input_field = document.querySelector('.i-13');
...
function f14() {
    let textarea_field = document.querySelector('.t-14');
    let output = document.querySelector('.out-14');
    output.innerHTML = textarea_field.value;
}
...
function f15() {
    let input_field = document.querySelector('.i-15');
    let textarea_field = document.querySelector('.t-15');
    let output = document.querySelector('.out-15');
    
    let text = input_field.value;
    textarea_field.value = text;
...
function f16() {
    ...
    let select_field = document.querySelector('.s-16');
    let output = document.querySelector('.out-16');

    let selected_option = select_field.value;
    output.innerHTML = selected_option;
...
// Создайте select.s-17. Добавьте ему событие onchange, при наступлении которого запускается функция f17. Функция должна выводить в out-17 value выбранного в select option.
    ...
    function f17() {
        let select_field = document.querySelector('.s-17');
...
function f18() {
    let select_field = document.querySelector('.s-18');
    let input_field = document.querySelector('.i-18');

    let selected_option = select_field.value;
    input_field.value = selected_option;
}
...
function f19() {
    ...
    output.innerHTML = `${form[0].value} ${form[1].value}`
}
...
function f20(e) {
    ...
    output.innerHTML = `${user_val} - ${pass_val}`
