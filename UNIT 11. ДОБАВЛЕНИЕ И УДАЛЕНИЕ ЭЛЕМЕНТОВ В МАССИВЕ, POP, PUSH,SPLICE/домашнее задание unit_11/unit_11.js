...
function f1() {
    let input_field = document.querySelector('.i-1');
...
function f4() {
    let input_field = document.querySelector('.i-4');
    let val = input_field.value;
    d1.push(val);
...
function f5() {
    let input_field = document.querySelector('.i-5');
    let val = input_field.value;
    d1.unshift(val);
...
function f6() {
    let input_field = document.querySelector('.i-6');
    let val = input_field.value;
    d6[d6.length] = val;
...
function f8() {
    let input_field = document.querySelector('.i-8');
    let val = input_field.value;
...
function f11() {
    let input_field = document.querySelector('.i-11');
    let val = +input_field.value;
...
function f14() {
    let input_field = document.querySelector('.i-14');
    let val = +input_field.value;
...
function f17() {
    ...
    for(let i=0; i<d171.length; i++){ // adding first array to d17
        d17[i] = d171[i];
    }

    tempIndex = d17.length;

    for(let k=0; k<d172.length; k++){ // adding second array
        d17[tempIndex] = d172[k];
        tempIndex++;
    }
...
function f20() {
    let newarr = d20.join('');
    document.querySelector('.out-20').textContent = newarr;
}
