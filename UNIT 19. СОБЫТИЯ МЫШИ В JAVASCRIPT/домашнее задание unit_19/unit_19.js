...
function t9() {
    if(document.querySelector('.div-9 img').getAttribute('src') == 'img/1.png'){
...
function t15() {
    let val = +document.querySelector('.div-15').textContent;
    document.querySelector('.div-15').textContent = val + 1;
}
...
function t18() {
    var elemWidth =  document.querySelector('.div-18').offsetWidth; 
    document.querySelector('.div-18').textContent = `${elemWidth}px`
}
...
function t19() {
    let classes = document.querySelector('.div-19').className;
    document.querySelector('.div-19').textContent = classes;
}
