...
function t1() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Denys')
        .then(data => {
            resolve(data.text());
        })
    })
...
function t2() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=5&num2=9')
        .then(data => {
            resolve(data.text());
        })
    })
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=5&num2=9')
        .then(data => {
            resolve(data.text());
        })
    })
...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=5&num2=9')
        .then(data => {
            resolve(data.text());
        })
    })
...
function t4() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1986')
        .then(data => {
            resolve(data.text());
        })
    })
...
document.querySelector('.b-4').onclick  = t4; // in html в этом задании опечатка (button с классом b-7)
...
function t5() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            body: 'auth=5ADcB96BA48d3f80&action=2&name=Dnys'
        })
        .then(data => {
            resolve(data.text());
        })
...
function t6() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            body: 'auth=5ADcB96BA48d3f80&action=3&num1=5&num2=9'
        })
        .then(data => {
            resolve(data.text());
        })
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            body: 'auth=5ADcB96BA48d3f80&action=4&num1=5&num2=9'
        })
        .then(data => {
            resolve(data.text());
        })
...
function t7() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            body: 'auth=5ADcB96BA48d3f80&action=6&num1=5&num2=9'
        })
        .then(data => {
            resolve(data.text());
        })
...
function t8() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            body: 'auth=5ADcB96BA48d3f80&action=8&year=1986'
        })
        .then(data => {
            resolve(data.text());
        })
